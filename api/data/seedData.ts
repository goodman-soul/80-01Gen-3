...
export const seedVendorUsers: VendorUser[] = [
  {
    id: 'v1',
    username: 'vendor01',
    password: '123456',
...
export const seedProductBatches: ProductBatch[] = [
  {
    id: 'b1',
...
export const seedInspectionReports: InspectionReport[] = [
  {
    id: 'i1',
    batchId: 'b1',
...
export const seedPatrolRecords: PatrolRecord[] = [
  {
    id: 'p1',
    adminId: 'a1',
    adminName: '李管理',
